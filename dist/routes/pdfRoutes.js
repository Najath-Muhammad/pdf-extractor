...
pdfRouter.post(routes_1.API_ROUTES.PDF.UPLOAD, uploadMiddleware_1.default.single("pdf"), (req, res, next) => pdfController.uploadPdf(req, res, next));
pdfRouter.post(routes_1.API_ROUTES.PDF.EXTRACT, (req, res, next) => pdfController.extractPdf(req, res, next));
